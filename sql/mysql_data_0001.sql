...
INSERT INTO `protocol_types` (`id`, `name`, `valid`) VALUES (NULL, 'Default', '1');

INSERT INTO `config` (`name`, `value`, `comment`) VALUES ('tmce.default.css', 'default', 'Name of default CSS style (tcme_<tcme.default.css>.css)');