INSERT INTO `file` (`id`, `name`, `file_type`, `filename`, `cached`, `valid`, `last_modified`, `modified_by`)
VALUES (NULL, '', 0, 0, NULL, '', CURRENT_TIMESTAMP, 0);


INSERT INTO `file_type` (`id`, `mimetype`, `extension`)
...
INSERT INTO `navi` (`id`, `name`, `parent`, `file_param`, `position`, `show`, `valid`, `required_permission`, `last_modified`)
	VALUES 
